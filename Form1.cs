...
namespace InDepthWin
{
    public partial class Form1 : Form
    {
        ...
        protected void OnPressedStart(object sender, EventArgs e)
        {
            VISIBLE();
            INVISIBLE();
            SCAN();
        ...
        private void SendCommando(object sender, KeyPressEventArgs e)
        {
        ...
        public void TALKTO(int i, String text)
        {
            talkingto = world.ListPeople[i].pindex;
