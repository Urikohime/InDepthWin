...
namespace InDepthWin
{
	class Player
	{
		...
		public void Alliance(String alli)
		{
			...
			{
				case "CONM":
				phealth = 100000; pattack = 200; pdefence = 30; pstorage = 30;
				pfirerate = 5; pability = "Overcharge"; Allegiance = "CONM";
				break;

				case "AOBO":
				phealth = 150000; pattack = 150; pdefence = 40; pstorage = 30;
				pfirerate = 3; pability = "EnergyFlow"; Allegiance = "AOBO";
				break;

				case "TSIB":
				phealth = 175000; pattack = 125; pdefence = 50; pstorage = 40;
				pfirerate = 3; pability = "LightBreak"; Allegiance = "TSIB";
				break;

				case "NLFD":
				phealth = 150000; pattack = 175; pdefence = 40; pstorage = 60;
				pfirerate = 4; pability = "Scavenge"; Allegiance = "NLFD";
				break;

				case "RUOP":
				phealth = 100000; pattack = 150; pdefence = 50; pstorage = 50;
				pfirerate = 3; pability = "Commerce"; Allegiance = "RUOP";
				break;

				case "CPMC":
				phealth = 175000; pattack = 190; pdefence = 40; pstorage = 30;
